                    ...
                    <div class="text_panel2">
                        <ul class="figs">
                            <li class="fig">
                                ...
                                <p class="txt">推荐配置要求：<br>第七代智能英特尔酷睿i5处理器以上<br>16G内存、7200转机械硬盘或SSD固态硬盘<br>Windows10或MacOS 10.12+操作系统<br> NVIDIA GeForce系列 GTX 960以上(Windows)<br>最佳使用分辨率2560x1600(全屏)</p>
                                <div class="links">
