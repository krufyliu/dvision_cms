                    ...
                    <div class="text_panel2">
                        <ul class="figs">
                            <li class="fig">
                                ...
                                <div class="links">
                                  <a href="https://cdn.visiondk.com/download/aura/studio/aura_studio_v1.1.2_win.zip" title="aura_studio_v1.1.2_win.zip" class="link"  target="_blank" rel="nofollow"><img src="/img/icon-win.png" width="17" class="ics" draggable="false">&nbsp;Win10</a>
                                  <a href="https://cdn.visiondk.com/download/aura/studio/aura_studio_v1.1.2_mac.dmg" title="aura_studio_v1.1.2_mac.dmg" class="link" target="_blank" rel="nofollow"><img src="/img/icon-mac.png" width"17" class="ics" draggable="false">&nbsp;MacOS</a>
                                  {{-- <a href="/contact" class="link" rel="nofollow">使用必读</a> --}}
                                </div>
                                <p class="txt small">2017.05.22 已更新至 v1.1.2</p>
                                {{-- <p class="txt">未开放下载</p> --}}
                            </li>
                            <li class="fig right">
                                <div class="icons">
