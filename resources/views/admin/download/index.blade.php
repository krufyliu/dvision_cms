                    ...
                    <div role="tabpanel" class="tab-pane" id="aura20">
                        ...
                        <div class="panel panel-info">
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    <label class="control-label">Image URL</label>
                                    {!! Form::text('aura20[live][image_url]', null, ['class' => 'form-control']) !!}
                                </div>
                                <div class="form-group">
                                    <label class="control-label">URL</label>
                                    {!! Form::text('aura20[live][url]', null, ['class' => 'form-control']) !!}
                                </div>
                                <div class="form-group">
                                    <label class="control-label">Title</label>
                                    {!! Form::text('aura20[live][title]', null, ['class' => 'form-control']) !!}
                                </div>
                                <div class="form-group">
                                    <label class="control-label">Version</label>
                                    {!! Form::text('aura20[live][version]', null, ['class' => 'form-control']) !!}
                                </div>
                            </div>
                        </div>
